...
function rzpwc_addAffordabilityWidgetHTML()
{
...
function rzpwc_getAdditionalOffers()
{
    $additionalOffers = '[]';
...
function rzpwc_getAffordabilityWidgetSettings()
{
    global $current_section;
    $settings = array();
...
function rzpwc_displayAffordabilityWidgetSettings()
{
...
function rzpwc_updateAffordabilityWidgetSettings()
{
...
function rzpwc_isEnabled($feature)
{
...
function rzpwc_getCustomisation($customisation)
{
...
function rzpwc_isAffordabilityWidgetTestModeEnabled()
{
